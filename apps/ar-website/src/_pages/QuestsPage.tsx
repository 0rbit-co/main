...
import { Footer, Nav, QuestCard } from "../_components";
import { brandDarkText, brandSecondaryBg, brandSecondaryText } from "../_utils/colors";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4 pb-8">
          <button
            className={`text-center text-black text-lg font-semibold ${brandSecondaryBg} ${
              activeTab === "active" ? "" : "opacity-60"
